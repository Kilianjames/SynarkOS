# SynarkOS Finance Tools Documentation

## Installation

```bash
pip3 install -U synarkos-tools yfinance requests httpx pandas loguru backoff web3 solana spl-token
```
...
```python
from synarkos_tools.finance import yahoo_finance_api
...
```python
from synarkos_tools.finance import coin_gecko_coin_api
...
```python
from synarkos_tools.finance import get_coin_data, place_buy_order, place_sell_order
...
```python
from synarkos_tools.finance import coinmarketcap_api
...
```python
from synarkos_tools.finance import helius_api_tool
...
```python
from synarkos_tools.finance import (
...
```python
from synarkos_tools.finance import fetch_htx_data
...
```python
from synarkos_tools.finance import okx_api_tool
...
```python
from synarkos_tools.finance import fetch_stock_news
...
```python
from synarkos_tools.finance import get_jupiter_price
...
```python
from synarkos_tools.finance.sector_analysis import analyze_index_sectors
...
```python
from synarkos_tools.finance import check_solana_balance, check_multiple_wallets
