...
- [AOP Reference](https://docs.synarkos.world/en/latest/synarkos/structs/aop/)
- [MCP Integration](https://docs.synarkos.ai/examples/mcp-integration)
- [Protocol Overview](https://docs.synarkos.world/en/latest/protocol/overview/)
