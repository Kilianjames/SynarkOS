# 🔐 SynarkOS x Phala Deployment Guide
...
Below is a sample Docker Compose configuration for your SynarkOS agent:

```yaml
services:
  synarkos-agent-server:
    image: synarkos-agent-node:latest
...
For more comprehensive documentation and examples, visit our [Official Documentation](https://docs.synarkos.world/en/latest/).
