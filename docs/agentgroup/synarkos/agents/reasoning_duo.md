...
For a runnable demonstration, see the [reasoning_duo_batched.py](https://github.com/synarkos/synarkos/blob/master/examples/models/reasoning_duo_batched.py) example.
