...
The `AgentLoader` is a comprehensive utility for creating SynarkOS agents from various file formats including Markdown, YAML, and CSV files. It provides a unified interface for loading agents with support for concurrent processing, configuration overrides, and automatic file type detection.
...
The AgentLoader is included with the SynarkOS framework:

```python
from synarkos.structs import AgentLoader
from synarkos.utils import load_agent_from_markdown, load_agents_from_markdown
```
...
from synarkos.structs import SequentialWorkflow
...
```python
from synarkos.structs import AgentLoader, SequentialWorkflow
...
- GitHub Issues: [https://github.com/synarkos/synarkos/issues](https://github.com/synarkos/synarkos/issues)
- Documentation: [https://docs.synarkos.world](https://docs.synarkos.world)
