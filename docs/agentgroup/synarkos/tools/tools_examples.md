# SynarkOS Tools Documentation

SynarkOS provides a comprehensive toolkit for integrating various types of tools into your AI agents. This guide covers all available tool options including callable functions, MCP servers, schemas, and more.
...
SynarkOS provides a comprehensive suite of tool integration methods to enhance your AI agents' capabilities:
...
Callable functions are the simplest way to add tools to your SynarkOS agents. They are regular Python functions with type hints and comprehensive docstrings.
