...
!!! abstract "Overview"
    Learn how to create and configure a group chat with multiple AI agents using the SynarkOS framework. This example demonstrates how to set up agents for expense analysis and budget advising.
...
!!! info "Before You Begin"
    ...
    - The SynarkOS package installed
...
- [SynarkOS Documentation](https://docs.synarkos.world)
- [API Reference](https://docs.synarkos.world/api)
- [Examples Gallery](https://docs.synarkos.world/examples)