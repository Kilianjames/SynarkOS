...
This tutorial shows how to process multiple images with a single agent using SynarkOS' multi-modal capabilities. You'll learn to configure an agent for batch image analysis, enabling efficient processing for quality control, object detection, or image comparison tasks.
...
from synarkos.prompts.logistics import (
