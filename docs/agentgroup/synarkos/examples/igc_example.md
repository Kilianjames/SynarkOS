...
For comprehensive documentation on Interactive GroupChat, visit: [Interactive GroupChat Documentation](https://docs.synarkos.world/en/latest/synarkos/structs/interactive_groupchat/)
...
Install the synarkos package using pip:

```bash
pip install -U synarkos
```
