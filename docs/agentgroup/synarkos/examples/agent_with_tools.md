...
This tutorial demonstrates how to create and use tools (callables) with the SynarkOS framework. Tools are Python functions that your agent can call to perform specific tasks, interact with external services, or process data. We'll show you how to build well-structured tools and integrate them with your agent.
...
1. First, install the latest version of SynarkOS:
