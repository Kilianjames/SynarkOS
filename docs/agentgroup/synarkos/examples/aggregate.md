...
You can get started by first installing synarkos with the following command, or [click here for more detailed installation instructions](https://docs.synarkos.world/en/latest/synarkos/install/install/):
