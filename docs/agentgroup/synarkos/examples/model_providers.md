...
SynarkOS supports a vast array of model providers, giving you the flexibility to choose the best model for your specific use case. Whether you need high-performance inference, cost-effective solutions, or specialized capabilities, SynarkOS has you covered.
...
All model providers follow a consistent pattern in SynarkOS. Here's the basic template:
...
SynarkOS allows you to create workflows that use different models for different tasks:
...
```python
from synarkos import Agent, ModelRouter
...
- **Community**: Join the SynarkOS community for support and best practices
...
!!! success "Ready to Get Started?"
    Choose a model provider from the table above and follow the detailed integration guide. Each provider offers unique capabilities that can enhance your SynarkOS applications.
