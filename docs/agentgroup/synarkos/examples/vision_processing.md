...
This example demonstrates how to use vision-enabled agents in SynarkOS to analyze images and process visual information. You'll learn how to work with both OpenAI and Anthropic vision models for various use cases.
...
```python
from synarkos.structs import Agent
from synarkos.prompts.logistics import Visual_Analysis_Prompt
