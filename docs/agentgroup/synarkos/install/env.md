...
SynarkOS uses environment variables for configuration management and secure credential storage. This approach keeps sensitive information like API keys out of your code and allows for easy configuration changes across different environments.
...
=== "Configuration Variables"
    ...
    |----------|-------------|---------|
    | `SYNARKOS_VERBOSE_GLOBAL` | Controls global logging verbosity | `True` or `False` |
...
=== "Development"
    ```bash
    WORKSPACE_DIR="agent_workspace"
    SYNARKOS_VERBOSE_GLOBAL="True"
    ```

=== "Production"
    ```bash
    WORKSPACE_DIR="/var/synarkos/workspace"
    SYNARKOS_VERBOSE_GLOBAL="False"
    ```
