...
- **[ConcurrentWorkflow](https://docs.synarkos.world/en/latest/synarkos/structs/concurrent_workflow/)**: For running agents in parallel
- **[AgentRearrange](https://docs.synarkos.world/en/latest/synarkos/structs/agent_rearrange/)**: For complex agent relationships and dynamic flows
- **[SwarmRouter](https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/)**: Universal orchestrator for switching between different swarm types
