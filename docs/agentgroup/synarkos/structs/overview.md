...
This page provides a comprehensive overview of all available multi-agent architectures in SynarkOS, their use cases, and functionality.
...
=== "Hierarchical Architectures"
    ...
    | Auto Swarm Builder | Automated swarm creation | Automatically creates and configures synarkos | [Docs](auto_swarm_builder.md) |
