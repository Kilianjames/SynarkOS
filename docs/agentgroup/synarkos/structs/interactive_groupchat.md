...
```python
from synarkos import Agent, InteractiveGroupChat
...
from synarkos.structs.interactive_groupchat import round_robin_speaker
...
**Example:**
```python
from synarkos.structs.interactive_groupchat import random_speaker, priority_speaker
...
```python
from synarkos.structs.interactive_groupchat import InteractiveGroupChat, round_robin_speaker
...
```python
from synarkos.structs.interactive_groupchat import InteractiveGroupChat, random_speaker
...
```python
from synarkos.structs.interactive_groupchat import InteractiveGroupChat, priority_speaker
...
```python
from synarkos.structs.interactive_groupchat import InteractiveGroupChat, random_dynamic_speaker
