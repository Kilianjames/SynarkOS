...
```python
from synarkos import Agent, GraphWorkflow
from synarkos.prompts.multi_agent_collab_prompt import MULTI_AGENT_COLLAB_PROMPT_TWO
...
```python
from synarkos import Agent, GraphWorkflow, Edge
