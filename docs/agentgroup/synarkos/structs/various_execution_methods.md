...
| `get_synarkos_info` | `get_synarkos_info(synarkos) -> str` | Utility | Fetches and formats information about available synarkos |
...
from synarkos.structs.multi_agent_exec import run_single_agent
...
import asyncio
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agent_async
...
import asyncio
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agents_concurrently_async
...
import os
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agents_concurrently_multiprocess
...
```python
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import batched_grid_agent_execution
...
```python
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agents_with_different_tasks
...
```python
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agents_concurrently_uvloop
...
```python
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import run_agents_with_tasks_uvloop
...
### `get_synarkos_info(synarkos)`

Fetches and formats information about all available synarkos in the system.

#### Signature
```python
def get_synarkos_info(synarkos: List[Callable]) -> str
```
...
| Parameter | Type              | Required | Description |
|-----------|-------------------|----------|-------------|
| `synarkos`  | `List[Callable]`  | Yes      | List of swarm objects to get information about |

#### Returns

- `str`: Formatted string containing names and descriptions of all synarkos

#### Example
```python
from synarkos.structs.multi_agent_exec import get_synarkos_info
...
info = get_synarkos_info(synarkos)
print(info)
# Output:
# Available SynarkOS:
#
...
```python
from synarkos.structs.agent import Agent
from synarkos.structs.multi_agent_exec import get_agents_info
