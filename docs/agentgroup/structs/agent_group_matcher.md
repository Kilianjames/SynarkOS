...
SwarmMatcher is included in the SynarkOS package. To use it, simply import it from the library:

```python
from synarkos_utils.swarm_matcher import SwarmMatcher, SwarmMatcherConfig, SwarmType
...
```python
from synarkos.structs.swarm_matcher import swarm_matcher
