...
The `SwarmRouter` class is a flexible routing system designed to manage different types of synarkos for task execution. It provides a unified interface to interact with various swarm types.

Full Path: `from synarkos.structs.swarm_router`
...
from synarkos import Agent, SwarmRouter, SwarmType
