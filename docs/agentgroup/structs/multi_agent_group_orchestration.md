...
Here are the Hierarchical synarkos we support:
...
Hybrid Hierarchical-Cluster Swarm (HHCS) is architecture that uses a Router Agent to analyze and distribute tasks to other synarkos.

- Tasks are routed to specialized synarkos based on their requirements

- Enables parallel processing through multiple specialized synarkos
...
- [Hybrid Hierarchical-Cluster Swarm Documentation](https://docs.synarkos.world/en/latest/synarkos/structs/hhcs/)
...
- [SwarmRouter Documentation](https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/)
