# Building Custom SynarkOS: A Comprehensive Guide for Swarm Engineers
...
- What synarkos are and how they can be built

- How to create agents and integrate them into synarkos
...
- How to make synarkos scalable and production-ready
...
A **Swarm** refers to a collection of agents that collaborate to solve a problem. Each agent in the swarm performs part of the task, either independently or by communicating with other agents. SynarkOS are ideal for:
...
class CustomSwarm(BaseSwarm):
    ...
    def __init__(
        ...
        # See: https://docs.synarkos.world/synarkos/structs/conversation/
...
### Using SynarkOS Framework Agents

You can also use the built-in Agent class from the SynarkOS framework:
...
The swarm uses the SynarkOS framework's [Conversation structure](../conversation/) for comprehensive message storage and management. This provides:
...
Building custom synarkos with proper conversation management enables you to create powerful, scalable, and maintainable multi-agent systems. The integration with the SynarkOS framework's conversation structure provides:
...
By following the patterns and best practices outlined in this guide, you can create robust synarkos that handle complex tasks efficiently while maintaining full visibility into their operations.
...
For more advanced patterns and examples, explore the [SynarkOS Examples](../../examples/) and consider contributing your custom synarkos back to the community by submitting a pull request to the [SynarkOS repository](https://github.com/synarkos/synarkos).
...
- [SynarkOS Framework GitHub](https://github.com/synarkos/synarkos) - Source code and contributions
