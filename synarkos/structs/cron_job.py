...
class CronJob:
    """A wrapper class that turns any callable (including SynarkOS agents) into a scheduled cron job.
    ...
    Attributes:
        agent: The SynarkOS Agent instance or callable to be scheduled
