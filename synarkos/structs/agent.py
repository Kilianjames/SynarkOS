...
from synarkos.agents.ape_agent import auto_generate_prompt
from synarkos.artifacts.main_artifact import Artifact
from synarkos.prompts.agent_system_prompts import AGENT_SYSTEM_PROMPT_3
from synarkos.prompts.max_loop_prompt import generate_reasoning_prompt
from synarkos.prompts.multi_modal_autonomous_instruction_prompt import (
    MULTI_MODAL_AUTO_AGENT_SYSTEM_PROMPT_1,
)
from synarkos.prompts.react_base_prompt import REACT_SYS_PROMPT
from synarkos.prompts.safety_prompt import SAFETY_PROMPT
from synarkos.prompts.tools import tool_sop_prompt
from synarkos.schemas.agent_mcp_errors import (
    AgentMCPConnectionError,
    AgentMCPToolError,
)
from synarkos.schemas.agent_step_schemas import ManySteps, Step
from synarkos.schemas.base_schemas import (
    AgentChatCompletionResponse,
)
from synarkos.schemas.conversation_schema import ConversationSchema
from synarkos.schemas.mcp_schemas import (
    MCPConnection,
    MultipleMCPConnections,
)
from synarkos.structs.agent_roles import agent_roles
...
from synarkos.structs.safe_loading import (
    SafeLoaderUtils,
    SafeStateManager,
)
from synarkos.structs.transforms import (
    MessageTransforms,
    TransformConfig,
    handle_transforms,
)
...
from synarkos.utils.data_to_text import data_to_text
from synarkos.utils.dynamic_context_window import dynamic_auto_chunking
from synarkos.utils.file_processing import create_file_in_folder
from synarkos.utils.formatter import formatter
from synarkos.utils.generate_keys import generate_api_key
from synarkos.utils.history_output_formatter import (
    history_output_formatter,
)
from synarkos.utils.index import (
    exists,
...
class Agent:
    ...
    def _handle_run_error(self, error: any):
        ...
        logger.error(
            ...
            f"Please optimize your input parameters, or create an issue on the SynarkOS GitHub and contact our team on Discord for support. "
            f"For technical support, refer to this document: https://docs.synarkos.world/en/latest/synarkos/support/"
        )
        ...
        **kwargs,
        ...
        try:
            ...
            logger.warning(
                ...
                "For technical support, refer to this document: https://docs.synarkos.world/en/latest/synarkos/support/"
            )
