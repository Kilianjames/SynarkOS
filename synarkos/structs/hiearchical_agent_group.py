...
from synarkos.prompts.hiearchical_system_prompt import (
    HIEARCHICAL_SWARM_SYSTEM_PROMPT,
)
from synarkos.prompts.multi_agent_collab_prompt import (
    MULTI_AGENT_COLLAB_PROMPT_TWO,
)
from synarkos.prompts.reasoning_prompt import INTERNAL_MONOLGUE_PROMPT
...
from synarkos.structs.omni_agent_types import AgentListType
...
class HierarchicalSwarmDashboard:
    ...
    Attributes:
        ...
        agent_group_name (str): Name of the swarm being monitored
    ...
    def __init__(self, agent_group_name: str = "SynarkOS Corporation"):
        """
        Initialize the Arasaka dashboard.

        Args:
            agent_group_name (str): Name of the swarm to display in the dashboard
        """
    ...
    def _create_header(self) -> Panel:
        """Create the dashboard header with SynarkOS Corporation branding."""
        header_text = Text()
        header_text.append(
            "╔══════════════════════════════════════════════════════════════════════════════╗\n",
            style="bold red",
        ...
        header_text.append("                    ", style="bold red")
        header_text.append(
            "SYNARKOS CORPORATION", style="bold white on red"
        )
        header_text.append("                    ", style="bold red")
        header_text.append("║\n", style="bold red")
        header_text.append("║", style="bold red")
    ...
    def _create_status_panel(self) -> Panel:
        ...
        status_text.append(
            "By the SynarkOS Corporation", style="bold cyan"
        )
        status_text.append("\n", style="white")
        status_text.append(
        ...
        status_text.append(f"{self.agent_group_name}", style="bold cyan")
...
class HierarchicalSwarm:
    ...
    def setup_director(self):
        ...
        try:
            ...
            error_msg = f"[ERROR] Failed to setup director: {str(e)}\n[TRACE] Traceback: {traceback.format_exc()}\n[BUG] If this issue persists, please report it at: https://github.com/synarkos/synarkos/issues"
    ...
    def _get_interactive_task(self) -> str:
        ...
        if self.dashboard:
            self.dashboard.console.print(
                "\n[bold red]SYNARKOS CORPORATION[/bold red] - [bold white]TASK INPUT REQUIRED[/bold white]"
            )
            self.dashboard.console.print(
