...
from synarkos.prompts.multi_agent_collab_prompt import (
...
from synarkos.structs.groupchat import GroupChat
from synarkos.structs.heavy_swarm import HeavySwarm
from synarkos.structs.hiearchical_swarm import HierarchicalSwarm
from synarkos.structs.interactive_groupchat import InteractiveGroupChat
from synarkos.structs.ma_utils import list_all_agents
...
from synarkos.telemetry.log_executions import log_execution
...
class SwarmRouter:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._swarm_cache = {}  # Cache for created synarkos
        ...
        try:
            ...
            if self.verbose:
                logger.info(
                    ...
                    "please visit: https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/"
                )

            # Check swarm type first since it affects other validations
            if self.swarm_type is None:
                raise SwarmRouterConfigError(
                    "SwarmRouter: Swarm type cannot be 'none'. Check the docs for all the swarm types available. https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/"
                )
            ...
            if (
                ...
                raise SwarmRouterConfigError(
                    "SwarmRouter: No agents provided for the swarm. Check the docs to learn of required parameters. https://docs.synarkos.world/en/latest/synarkos/structs/agent/"
                )
            ...
            if (
                ...
                raise SwarmRouterConfigError(
                    "SwarmRouter: rearrange_flow cannot be 'none' when using AgentRearrange. Check the SwarmRouter docs to learn of required parameters. https://docs.synarkos.world/en/latest/synarkos/structs/agent_rearrange/"
                )

            # Validate max_loops
            if self.max_loops == 0:
                raise SwarmRouterConfigError(
                    "SwarmRouter: max_loops cannot be 0. Check the docs for all the max_loops available. https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/"
                )
    ...
    def _run(
        ...
        **kwargs,
        ...
        log_execution(
            ...
            agent_architecture="swarm_router",
        ...
        try:
            ...
            logger.error(
                ...
                "  https://docs.synarkos.world/en/latest/synarkos/structs/swarm_router/\n"
            )
            raise e
