...
"""
User-Facing Example: How to get XML output from a SynarkOS agent
-------------------------------------------------------------
This example demonstrates how to use the SynarkOS agent framework to generate output in XML format.
