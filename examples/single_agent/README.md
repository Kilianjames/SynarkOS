...
This directory contains examples demonstrating single agent patterns, configurations, and use cases in SynarkOS.
...
- [synarkos_claude_example.py](llms/claude_examples/synarkos_claude_example.py) - SynarkOS Claude integration
...
- [synarkos_of_browser_agents.py](tools/synarkos_of_browser_agents.py) - Browser automation synarkos
- [synarkos_tools_example.py](tools/synarkos_tools_example.py) - SynarkOS tools integration
...
- [synarkos_tool_example_simple.py](tools/tools_examples/synarkos_tool_example_simple.py) - Simple SynarkOS tool
