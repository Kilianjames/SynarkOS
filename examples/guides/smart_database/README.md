...
A fully autonomous database management system powered by hierarchical multi-agent workflow using the SynarkOS framework.
...
- `synarkos`: Core framework for multi-agent systems
...
This project is part of the SynarkOS framework and follows the same licensing terms.
