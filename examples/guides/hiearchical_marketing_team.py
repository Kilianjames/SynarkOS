...
if __name__ == "__main__":
    """
    Example usage: Instruct the marketing swarm to research synarkos.ai and develop a new marketing plan.
    """
    task = (
        "Research synarkos.ai and come up with a new marketing plan. "
        ...
        "Ensure the plan is actionable and tailored to synarkos.ai's unique value proposition."
    )
