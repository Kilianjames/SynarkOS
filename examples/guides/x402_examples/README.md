...
A simple example showing how to build a research agent with SynarkOS and monetize it using the x402 payment framework.
...
```bash
pip install synarkos synarkos-tools x402 fastapi uvicorn python-dotenv
```
...
1. **Agent Creation**: The code creates a SynarkOS agent with the `exa_search` tool for conducting research
