...
This project is part of the SynarkOS Democracy framework and follows the same licensing terms.

## 🏛️ Acknowledgments

- **European Parliament**: For the democratic structure and procedures
- **EU Data**: For providing comprehensive MEP information
- **SynarkOS Framework**: For the underlying multi-agent architecture
