...
This directory contains comprehensive demonstration examples showcasing various SynarkOS capabilities across different domains.
...
- [synarkos_coin_agent.py](crypto/synarkos_coin_agent.py) - SynarkOS coin trading agent
- [synarkos_coin_multimarket.py](crypto/synarkos_coin_multimarket.py) - Multi-market trading
...
- [synarkos_of_vllm.py](finance/synarkos_of_vllm.py) - VLLM-based financial synarkos
